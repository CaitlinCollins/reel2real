...
var queryUrl = `https://api.discogs.com/database/search?key=nvWMvkXWSygfbACCOVQc&secret=mDVWMOCUTByoFszZgQyjUBnYcYbjnkYB&genre=${genre}&artist=${artist}&per_page=15&page=1`
// var imageQueryURL = "https://api.discogs.com/masters/{id}?key=nvWMvkXWSygfbACCOVQc&secret=mDVWMOCUTByoFszZgQyjUBnYcYbjnkYB"


async function getSearch(routeResponse) {
